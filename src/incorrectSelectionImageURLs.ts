const incorrectSelectionImageURLs: Array<string> = [
  ...
  'https://media.giphy.com/media/1wnnwuqafErMEks91R/giphy.gif',
  'https://media.giphy.com/media/1wnnwuqafErMEks91R/giphy.gif',
  'https://media.giphy.com/media/g0BZBXj1t5cfZnNnsg/giphy.gif',
  'https://media.giphy.com/media/l1KcPWJVOE6hRLMBi/giphy.gif',
